...
app.use('/swagger', swaggerUi.serve, swaggerUi.setup(swaggerSpec, {
  customCssUrl: 'https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.17.2/swagger-ui.min.css',
  customJs: 'https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.17.2/swagger-ui-bundle.min.js',
}))
