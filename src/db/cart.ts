...
export async function insertCartTable(cart: InsertCart) {
...
export async function updateCartTable(cart: UpdateCart) {
...
export async function clearCartTable(user_id: number) {
